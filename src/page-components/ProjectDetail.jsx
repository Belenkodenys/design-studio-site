...
import SEO, { getProjectSEO } from '../components/SEO'
...
function ProjectDetail() {
  ...
  const getImageAlt = (index) => {
    ...
    return `${project.title} ${project.category.toLowerCase()} ${descriptor} - ${project.location} interior design by Belenko Studio`
  }
  ...
  const seoData = getProjectSEO(project, language)
  ...
  return (
    <div className="project-detail">
      ...
      <header className="project-header">
        ...
        <a href="/" className="logo" onClick={(e) => { e.preventDefault(); navigate('/'); window.scrollTo({ top: 0, behavior: 'smooth' }) }}>
      ...
      <div className="project-hero">
        <div className="project-hero-image" onClick={() => openLightbox(currentImageIndex)}>
          <img src={project.images[currentImageIndex]} alt={getImageAlt(currentImageIndex)} />
