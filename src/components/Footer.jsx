      ...
      <div className="footer-container">
        <div className="footer-top">
          <div className="footer-brand">
            <a href="/" className="footer-logo" onClick={handleHomeClick}>BELENKO</a>
          ...
          <nav className="footer-nav">
            ...
            <a href="#gallery" className="footer-link" onClick={(e) => handleNavClick(e, 'gallery')}>{t('nav.portfolio')}</a>
            <Link to="/blog" className="footer-link">{t('nav.blog')}</Link>
            <Link to="/career" className="footer-link">{t('nav.career')}</Link>
